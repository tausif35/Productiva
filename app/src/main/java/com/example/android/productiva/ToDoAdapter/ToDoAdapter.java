...
import com.example.android.productiva.MainActivity;
import com.example.android.productiva.R;
import com.example.android.productiva.ToDoAddTask;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ViewHolder> {
    ...
    public ToDoAdapter(ToDoDatabaseHandler db, MainActivity activity) {
        this.db = db;
        this.activity = activity;
    }

    public ToDoAdapter(ToDoDatabaseHandler db, ToDoList toDoList) {
    }
    ...
    public void editItem(int position) {
        ...
        ToDoAddTask fragment = new ToDoAddTask();
        fragment.setArguments(bundle);
        fragment.show(activity.getSupportFragmentManager(), ToDoAddTask.TAG);
    }
