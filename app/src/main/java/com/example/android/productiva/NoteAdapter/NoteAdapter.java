package com.example.android.productiva.NoteAdapter;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NoteViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.note_item_container, parent, false));
    }
